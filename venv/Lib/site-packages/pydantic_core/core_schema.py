...
class CoreConfig(TypedDict, total=False):
    ...
    Attributes:
        ...
        from_attributes: Whether to use attributes for model, dataclasses, and tagged union keys.
        ...
        revalidate_instances: Whether instances of model and dataclasses should re-validate. Default is 'never'.
    ...
    # used for model, dataclasses, and tagged union keys
    from_attributes: bool
    # whether to use the used alias (or first alias for "field required" errors) instead of field_names
    # to construct error `loc`s, default True
    loc_by_alias: bool
    # whether instances of model and dataclasses (including subclass instances) should re-validate, default 'never'
...
def model_schema(
    ...
    *,
    ...
    Args:
        ...
        revalidate_instances: whether instances of model and dataclasses (including subclass instances)
...
def definition_reference_schema(
    ...
    model and also when you want to define validators separately from the main schema, e.g.:
