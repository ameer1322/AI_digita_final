...
# weak dictionaries allow the dynamically created parametrized versions of generic model to get collected
...
# _generic_types_cache is a Mapping from __class_getitem__ arguments to the parametrized version of generic model.
# This ensures multiple calls of e.g. A[B] return always the same class.
_generic_types_cache = GenericTypesCache()

# _assigned_parameters is a Mapping from parametrized version of generic model to assigned types of parametrizations
...
class GenericModel(BaseModel):
    ...
    def __class_getitem__(cls: Type[GenericModelT], params: Union[Type[Any], Tuple[Type[Any], ...]]) -> Type[Any]:
        ...
        # model that should be identical.
...
def replace_types(type_: Any, type_map: Mapping[Any, Any]) -> Any:
    ...
    # We handle pydantic generic model separately as they don't have the same
