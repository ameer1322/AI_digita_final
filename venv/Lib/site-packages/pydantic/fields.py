...
def Field(
    ...
    **extra: Any,
    ...
    :param discriminator: only useful with a (discriminated a.k.a. tagged) `Union` of sub model with a common field.
...
class DeferredType:
    """
    Used to postpone field preparation, while creating recursive generic model.
    """
